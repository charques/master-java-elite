...
public class Alfil extends Pieza {
	 ...
	 * @param color
	 */
	public Alfil(Posicion posicion, int color) {
	...
	public String getChar() {
		if(color == Constantes.BLANCAS)
			return Character.toString(Constantes.ALFIL);
		return  Character.toString(Constantes.ALFIL).toUpperCase();
	}

	@Override
	public Pieza clone() {
		return new Alfil(posicion.clone(), color); 
	}
