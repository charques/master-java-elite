...
public class Torre extends Pieza {
	 ...
	 * @param color
	 */
	public Torre(Posicion posicion, int color) {
	...
	public ArrayList<Movimiento> posiblesMovimientos(Tablero t) {
        ...
        // Procesa los 4 posibles direcciones
	...
	public String getChar() {
		if(color == Constantes.BLANCAS)
			return Character.toString(Constantes.TORRE);
		return  Character.toString(Constantes.TORRE).toUpperCase();
	}

	@Override
	public Pieza clone() {
		return new Torre(posicion.clone(), color); 
	}
}
