...
import edu.masterjava.servlets.tarea05_06.dao.impl.DynamicProductsDAOImpl;
 ...
 * Url pruebas:
 * 
 * http://localhost:8080/CU011_Servlets/ProductsServletDynamic
 * 
 * @author carloshernandezarques
 * 
 */
@WebServlet("/ProductsServletDynamic")
public class ProductsServletDynamic extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(Product item : productos) {
			...
			out.print("<a href='/CU011_Servlets/CartServletDynamic?add=" + item.getId() + "'>A–adir al carro</a>");
			out.print("<br/><br/>");
		}
		
		out.print("</br></br>");
		out.print("<a href='/CU011_Servlets/CartServletDynamic'>Ir al carro</a>");
		out.println("</body>");
		out.println("</html>");
		out.close();
	}
