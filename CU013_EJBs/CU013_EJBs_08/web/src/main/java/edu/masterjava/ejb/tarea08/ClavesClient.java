package edu.masterjava.ejb.tarea08;
...
import edu.masterjava.ejb.tarea08.bean.impl.ClaveExImpl;
...
public class ClavesClient {
	...
	private static ClaveExRemote lookupRemoteEJB() throws NamingException {
        ...
        final String appName = "cu013-tarea08-ear";
        final String moduleName = "cu013-tarea08-ejb";
